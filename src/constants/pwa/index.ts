export const pwaTags = [
  {
    ...
    rel: "icon",
    type: "image/x-icon",
    href: "/assets/apps/{{school}}/icon.png",
  },
  {
    id: "appTouchFavicon",
