...
export function MobileHeader({ children }: Props) {
  return (
    <div className='flex justify-between relative items-center w-full'>
      <button
        className='absolute top-[135%] left-0 -translate-y-1/2 border-0 hover:bg-slate-100 bg-transparent p-2 rounded-full flex justify-center items-center cursor-pointer'
